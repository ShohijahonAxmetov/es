...
class AnswerQuestionCharacterSeeder extends Seeder
{
    ...
    {
    	$probabilities = [
    		0.9, 0.1, 0.9, 0.9, 0.1, 0.5, 0.5,
    		0.1, 0.9, 0.1, 0.1, 0.9, 0.5, 0.5,

    		0.1, 0.2, 0.1, 0.9, 0.4, 0.5, 0.5,
    		0.9, 0.8, 0.9, 0.1, 0.6, 0.5, 0.5,

    		0.1, 0.6, 0.9, 0.1, 0.8, 0.5, 0.5,
    		0.9, 0.4, 0.1, 0.9, 0.2, 0.5, 0.5,
    	];
